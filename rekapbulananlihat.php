...
$datat = mysqli_fetch_assoc($query1);
  ...
  if($idus!=$cekus){
    header("Location: rekapbulanan.php");// send to login page
  }else{
                    ...
                    <div class="col-md-12">
                      ...
                      while ($d1 = mysqli_fetch_assoc($q1)) {
                        ...
                        while ($d2 = mysqli_fetch_assoc($q2)) {
                          ?>
                            <h5>Informasi Data Rekap Dari Kelas <u><?php echo $d1['namakelas'] ?></u> Oleh <u><?php echo $d2['namaguru'] ?></u> Pada Bulan
                              <u>
                              <?php
                              if($bulan=='1'){
                                echo "Januari";
                        ...
                        <table class="table table-striped table-bordered table-hover">
                          <thead>
                            ...
                            <tr>
                               <td colspan="4">
                                 <?php
                                 $tampilkd = mysqli_query($connect,"SELECT kd1nam FROM harianumum WHERE ajaran='$idajaran' AND MONTH(tglharianumum) = '$bulan' AND YEAR(tglharianumum) = '$tahun' GROUP BY kd1nam HAVING COUNT(*) >= 1");
                               ...
                               <td colspan="4">
                                 <?php
                                 $ttt2= mysqli_query($connect,"SELECT kd2fismot FROM harianumum WHERE ajaran='$idajaran' AND MONTH(tglharianumum) = '$bulan' AND YEAR(tglharianumum) = '$tahun' GROUP BY kd2fismot HAVING COUNT(*) >= 1");
                               ...
                               <td colspan="4">
                                 <?php
                                 $ttt3= mysqli_query($connect,"SELECT kd3kog FROM harianumum WHERE ajaran='$idajaran' AND MONTH(tglharianumum) = '$bulan' AND YEAR(tglharianumum) = '$tahun' GROUP BY kd3kog HAVING COUNT(*) >= 1");
                            ...
                            <tr>
                              <td colspan="4">
                                <?php
                                $tampilindikator1 = mysqli_query($connect,"SELECT indikator1 FROM harianumum WHERE ajaran='$idajaran' AND MONTH(tglharianumum) = '$bulan' AND YEAR(tglharianumum) = '$tahun' GROUP BY indikator1 HAVING COUNT(*) >= 1");
                                $eqew1 = 1;
                              ...
                              <td colspan="4">
                                <?php
                                $tampilindikator2 = mysqli_query($connect,"SELECT indikator2 FROM harianumum WHERE ajaran='$idajaran' AND MONTH(tglharianumum) = '$bulan' AND YEAR(tglharianumum) = '$tahun' GROUP BY indikator2 HAVING COUNT(*) >= 1");
                                $eqew2 = 1;
                              ...
                              <td colspan="4">
                                <?php
                                $tampilindikator3 = mysqli_query($connect,"SELECT indikator3 FROM harianumum WHERE ajaran='$idajaran' AND MONTH(tglharianumum) = '$bulan' AND YEAR(tglharianumum) = '$tahun' GROUP BY indikator3 HAVING COUNT(*) >= 1");
                                $eqew3 = 1;
                        ...
                        <table class="table table-striped table-bordered table-hover">
                          <thead>
                            ...
                            <tr>
                               <td colspan="4">
                                 <?php
                                 $ttt4= mysqli_query($connect,"SELECT kd4sosem FROM harianumum WHERE ajaran='$idajaran' AND MONTH(tglharianumum) = '$bulan' AND YEAR(tglharianumum) = '$tahun' GROUP BY kd4sosem HAVING COUNT(*) >= 1");
                               ...
                               <td colspan="4">
                                 <?php
                                 $ttt5= mysqli_query($connect,"SELECT kd5bhs FROM harianumum WHERE ajaran='$idajaran' AND MONTH(tglharianumum) = '$bulan' AND YEAR(tglharianumum) = '$tahun' GROUP BY kd5bhs HAVING COUNT(*) >= 1");
                               ...
                               <td colspan="4">
                                 <?php
                                 $ttt6 = mysqli_query($connect,"SELECT kd6seni FROM harianumum WHERE ajaran='$idajaran' AND MONTH(tglharianumum) = '$bulan' AND YEAR(tglharianumum) = '$tahun' GROUP BY kd6seni HAVING COUNT(*) >= 1");
                            ...
                            <tr>
                              <td colspan="4">
                                <?php
                                $tampilindikator4 = mysqli_query($connect,"SELECT indikator4 FROM harianumum WHERE ajaran='$idajaran' AND MONTH(tglharianumum) = '$bulan' AND YEAR(tglharianumum) = '$tahun' GROUP BY indikator4 HAVING COUNT(*) >= 1");
                                $eqew4 = 1;
                              ...
                              <td colspan="4">
                                <?php
                                $tampilindikator5 = mysqli_query($connect,"SELECT indikator5 FROM harianumum WHERE ajaran='$idajaran' AND MONTH(tglharianumum) = '$bulan' AND YEAR(tglharianumum) = '$tahun' GROUP BY indikator5 HAVING COUNT(*) >= 1");
                                $eqew5 = 1;
                              ...
                              <td colspan="4">
                                <?php
                                $tampilindikator6 = mysqli_query($connect,"SELECT indikator6 FROM harianumum WHERE ajaran='$idajaran' AND MONTH(tglharianumum) = '$bulan' AND YEAR(tglharianumum) = '$tahun' GROUP BY indikator6 HAVING COUNT(*) >= 1");
                                $eqew6 = 1;
